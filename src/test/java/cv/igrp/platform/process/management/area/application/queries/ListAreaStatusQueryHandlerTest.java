...
public class ListAreaStatusQueryHandlerTest {
  ...
  @InjectMocks
  private ListAreaStatusQueryHandler listAreaStatusQueryHandler;
  ...
  @Test
  void testHandleListAreaStatusQuery() {
    ...
    //
    // When
    // ResponseEntity<List<ConfigParameterDTO>> response = listAreaStatusQueryHandler.handle(query);
    //
    // Then
